...
export default function MyInfo() {
  ...
  return (
    <>
      <div className="pl-4 pr-1 lg:px-4 flex-shrink-0 h-14 lg:h-20 border-b border-b-primary flex justify-between items-center">
        <div className="flex gap-2 items-center justify-center">
          ...
          <p className="font-medium lg:font-normal lg:text-xl">{name}</p>
        </div>
        <DropdownMenu>
          <DropdownMenuTrigger asChild className="w-8 h-8 lg:w-10 lg:h-10">
            <Button size="icon" variant="ghost">
              <FeatherIcon icon="more-vertical" size={24} />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            className="flex z-20 rounded-lg border-2 bg-primary border-primary flex-col gap-2 p-2 min-w-[200px]"
            align="end"
            alignOffset={0}
            sideOffset={8}
          >
      ...
      <dialog
        ...
        className={`backdrop:bg-black/80 justify-center text-primary items-end lg:items-center bg-transparent max-w-none max-h-none h-screen w-screen ${isAboutSectionOpen ? "flex" : ""}`}
      >
        <div className="flex flex-col bg-primary w-fit lg:border-2 border-primary rounded-t-2xl lg:rounded-lg">
          <div className="flex justify-between px-4 pt-4 lg:p-5 items-center lg:border-b lg:border-b-primary">
            <h1 className="font-medium text-xl lg:text-2xl text-primary">
              About
            </h1>
            <div
            ...
            >
              <FeatherIcon
                icon="x"
                className="text-primary h-6 w-6 lg:w-[30px] lg:h-[30px]"
              />
            </div>
          </div>
          <div className="flex flex-col p-4 lg:p-5 gap-2 border-b border-b-primary">
            <Image
              src={Chating}
            ...
            <div>
              ...
              <p className="text-secondary lg:text-base text-sm">
                This is your new place to{" "}
                <span className="font-medium">Meet & Chat</span>
              </p>
            </div>
          </div>
          <p className="p-4 lg:p-5 text-secondary text-xs lg:text-sm">
            Made with{" "}
